...
public class CourseDriverEngine {
    // main program loop
    public static void loop(Course course, Scanner scnr){
        boolean quit = false;
        String response;
        Student temp;
        while (!quit){
    ...
    public static void main(String[] args){
        ...
        System.out.print("Welcome to course registration system! \nPlease enter name of new course: ");
        ...
        Course course = new Course(courseName, maxCourseMembers, maxWaitList);
        loop(course, scnr);
